/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fc32de6b334fe0d1230491ba57f22ea9)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production" | "development";
	RELEASE_VERSION: "0.2.0";
	NEWS_API: Fetcher /* studyai-news-api-staging */ | Fetcher /* studyai-news-api */ | Fetcher /* studyai-news-api-dev */;
}
declare namespace Cloudflare {
	interface StagingEnv {
		...
		ENVIRONMENT: "staging";
		RELEASE_VERSION: "0.2.0";
		NEWS_API: Fetcher /* studyai-news-api-staging */;
	}
	interface ProductionEnv {
		ASSETS: Fetcher;
		ENVIRONMENT: "production";
		RELEASE_VERSION: "0.2.0";
		NEWS_API: Fetcher /* studyai-news-api */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "RELEASE_VERSION">> {}
}
