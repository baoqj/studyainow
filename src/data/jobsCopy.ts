...
type JobsCopy = {
  ...
  metadataOnlyText: string;
  sourceNotice: string;
  sourceExcerptNotice: string;
  metadataOnlyNotice: string;
  extractedSignals: string;
  semanticSignalsNotice: string;
  apply: string;
...
const copy: Record<AppLocale, JobsCopy> = {
  'zh-CN': {
    ...
    skills: '项技能', skillMap: 'JD 技能与知识点', source: '官方来源', originalSourceText: '抓取原文 · 未翻译', sourceExcerptText: '官方原文摘录 · 未翻译', metadataOnlyText: '仅公开元数据', sourceNotice: '职位内容保留原始官方链接与发布日期；到达疑似过期日期后，系统会直接巡检该职位页。JD 始终显示采集到的原文，不进行翻译或摘要改写。', sourceExcerptNotice: '这里展示从官方职位正文中提取的有限原文摘录，不翻译、不改写。完整职位说明及申请要求请以官方来源为准。', metadataOnlyNotice: '该来源仅公开职位元数据。完整职位说明请前往官方来源；技能和知识点来自对私有抓取正文的语义分析。', extractedSignals: '语义提取的技能与知识点', semanticSignalsNotice: '以下关键词来自已保存正文的语义分析，可用于职位匹配；它们不是公开的逐句证据。',
  ...
  'zh-TW': {
    ...
    skills: '項技能', skillMap: 'JD 技能與知識點', source: '官方來源', originalSourceText: '擷取原文 · 未翻譯', sourceExcerptText: '官方原文摘錄 · 未翻譯', metadataOnlyText: '僅公開中繼資料', sourceNotice: '職缺內容保留原始官方連結與發布日期；到達疑似過期日期後，系統會直接巡檢該職缺頁。JD 一律顯示擷取的原文，不會翻譯或改寫摘要。', sourceExcerptNotice: '此處顯示從官方職缺正文擷取的有限原文摘錄，不翻譯、不改寫。完整說明與申請要求請以官方來源為準。', metadataOnlyNotice: '此來源僅公開職缺中繼資料。完整說明請前往官方來源；技能與知識點來自對私有擷取正文的語意分析。', extractedSignals: '語意提取的技能與知識點', semanticSignalsNotice: '以下關鍵詞來自已保存正文的語意分析，可用於職缺比對；它們不是公開的逐句證據。',
  ...
  en: {
    ...
    skills: 'skills', skillMap: 'JD skills and knowledge', source: 'Official source', originalSourceText: 'Acquired source text · not translated', sourceExcerptText: 'Official source excerpt · not translated', metadataOnlyText: 'Public metadata only', sourceNotice: 'Every listing preserves its original official URL and publication date. Once its suspected-expiry date is reached, the system inspects that exact posting URL. The JD is shown in its acquired original language, without translation or summary rewriting.', sourceExcerptNotice: 'This is a limited excerpt from the official job description in its source language, without translation or rewriting. See the official source for the complete role and application requirements.', metadataOnlyNotice: 'This source exposes public job metadata only. See the official source for the complete description; skills and knowledge points come from semantic analysis of the privately retained source text.', extractedSignals: 'Semantically extracted skills and knowledge', semanticSignalsNotice: 'These keywords come from semantic analysis of the retained source text and support job matching; they are not public sentence-level evidence.',
  ...
  fr: {
    ...
    skills: 'compétences', skillMap: 'Compétences et connaissances du JD', source: 'Source officielle', originalSourceText: 'Texte source collecté · non traduit', sourceExcerptText: 'Extrait officiel · non traduit', metadataOnlyText: 'Métadonnées publiques uniquement', sourceNotice: 'Chaque offre conserve son URL officielle d’origine et sa date de publication. À sa date d’expiration présumée, le système inspecte directement cette URL. Le JD est affiché dans sa langue d’origine, sans traduction ni réécriture en résumé.', sourceExcerptNotice: 'Il s’agit d’un extrait limité de la description officielle dans sa langue source, sans traduction ni réécriture. Consultez la source officielle pour le poste complet et les conditions de candidature.', metadataOnlyNotice: 'Cette source ne publie que les métadonnées du poste. Consultez la source officielle pour la description complète ; les compétences proviennent de l’analyse sémantique du texte source conservé en privé.', extractedSignals: 'Compétences et connaissances extraites', semanticSignalsNotice: 'Ces mots-clés proviennent de l’analyse sémantique du texte source conservé et servent à la mise en correspondance ; ce ne sont pas des preuves publiques phrase par phrase.',
  ...
  es: {
    ...
    skills: 'habilidades', skillMap: 'Habilidades y conocimientos del JD', source: 'Fuente oficial', originalSourceText: 'Texto original capturado · sin traducción', sourceExcerptText: 'Extracto oficial · sin traducción', metadataOnlyText: 'Solo metadatos públicos', sourceNotice: 'Cada oferta conserva su URL oficial original y su fecha de publicación. Al llegar su fecha de posible vencimiento, el sistema inspecciona directamente esa URL. El JD se muestra en el idioma original capturado, sin traducción ni reescritura resumida.', sourceExcerptNotice: 'Este es un extracto limitado de la descripción oficial en su idioma original, sin traducción ni reescritura. Consulta la fuente oficial para ver el puesto completo y los requisitos de solicitud.', metadataOnlyNotice: 'Esta fuente solo publica metadatos del puesto. Consulta la fuente oficial para ver la descripción completa; las habilidades proceden del análisis semántico del texto fuente conservado de forma privada.', extractedSignals: 'Habilidades y conocimientos extraídos', semanticSignalsNotice: 'Estas palabras clave proceden del análisis semántico del texto fuente conservado y ayudan a relacionar puestos; no son evidencia pública frase por frase.',
