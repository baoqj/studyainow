...
const copy: Record<AppLocale, NavigationCopy> = {
  'zh-CN': {
    public: { courses: 'AI课程', interviews: '面试题集', jobs: '工作机会', news: '新闻', resume: '简历制作', login: '登录', register: '注册' },
  ...
  'zh-TW': {
    public: { courses: 'AI課程', interviews: '面試題集', jobs: '工作機會', news: '新聞', resume: '履歷製作', login: '登入', register: '註冊' },
  ...
  en: {
    public: { courses: 'Courses', interviews: 'Interview Prep', jobs: 'Jobs', news: 'News', resume: 'CV Maker', login: 'Login', register: 'Register' },
  ...
  fr: {
    public: { courses: 'Cours', interviews: 'Entretiens', jobs: 'Offres d’emploi', news: 'Actualités', resume: 'Créateur de CV', login: 'Connexion', register: 'Créer un compte' },
  ...
  es: {
    public: { courses: 'Cursos', interviews: 'Entrevistas', jobs: 'Empleos', news: 'Noticias', resume: 'Creador de CV', login: 'Iniciar sesión', register: 'Registrarse' },
