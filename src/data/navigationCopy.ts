...
const copy: Record<AppLocale, NavigationCopy> = {
  'zh-CN': {
    public: { courses: 'AI课程', jobs: '工作机会', resume: '简历制作', login: '登录', register: '注册' },
  ...
  'zh-TW': {
    public: { courses: 'AI課程', jobs: '工作機會', resume: '履歷製作', login: '登入', register: '註冊' },
  ...
  en: {
    public: { courses: 'Courses', jobs: 'Jobs', resume: 'CV Maker', login: 'Login', register: 'Register' },
  ...
  fr: {
    public: { courses: 'Cours', jobs: 'Offres d’emploi', resume: 'Créateur de CV', login: 'Connexion', register: 'Créer un compte' },
  ...
  es: {
    public: { courses: 'Cursos', jobs: 'Empleos', resume: 'Creador de CV', login: 'Iniciar sesión', register: 'Registrarse' },
